...
--
-- Host: localhost
-- Generation Time: Jul 29, 2022 at 09:53 AM
...
--
-- Database: `predicting_employees_under_stress`
--
CREATE DATABASE IF NOT EXISTS `predicting_employees_under_stress` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
('eqq89xxy2myvjfuoo8hrj405rbs4wsxb', 'eyJ1c2VyaWQiOjF9:1oHJly:5GLd0yMIXABn7EyRot8L1VQot9O-2-EOZD_YqrXw944', '2022-08-12 06:46:58.196494'),
...
('u0vkif8sbibr4qhsuou5h0vovjma28xx', 'eyJ1c2VyaWQiOjJ9:1oGyoB:FNiMoP-CsiZ0B-JbUXEQzvwFtFgOeSHq54CX8NFQlfg', '2022-08-11 08:23:51.527860'),
('u1qezvdzpm462byhcg9dyz3en598xaou', 'eyJ1c2VyaWQiOjF9:1oGxFz:0CurshqO81tn1dwUsIjSbyevlqIdZyZvhH_F9gG3NvY', '2022-08-11 06:44:27.873945'),
...
('xm5xztzylutg3bgu38glspp68umym27f', 'eyJ1c2VyaWQiOjJ9:1oHMab:hrd9vtWKFHWVNl08xG3cOCVOJXb_WSnSRRTTc1lUEnk', '2022-08-12 09:47:25.694842'),
...
(1, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
...
(60, 'Naive Bayes', '62.85930408472012'),
(61, 'SVM', '62.85930408472012'),
(62, 'Logistic Regression', '62.85930408472012'),
(63, 'KNeighborsClassifier', '62.85930408472012'),
(64, 'Decision Tree Classifier', '37.14069591527988'),
(65, 'SGD Classifier', '62.85930408472012'),
(66, 'SVM', '63.767019667170956'),
(67, 'Decision Tree Classifier', '36.232980332829044');
...
--
-- Table structure for table `remote_user_predicting_employee_stress`
--

CREATE TABLE IF NOT EXISTS `remote_user_predicting_employee_stress` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `recruitment_channel` varchar(300) NOT NULL,
  `Training_Time` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `Prformance_Rating` varchar(300) NOT NULL,
  `Years_at_company` varchar(300) NOT NULL,
  `Working_Hours` varchar(300) NOT NULL,
  `Flexible_Timings` varchar(300) NOT NULL,
  `Workload_level` varchar(300) NOT NULL,
  `Monthly_Income` varchar(300) NOT NULL,
  `Work_Satisfaction` varchar(300) NOT NULL,
  `Percent_salary_hike` varchar(300) NOT NULL,
  `companies_worked` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predicting_employee_stress`
--

INSERT INTO `remote_user_predicting_employee_stress` (`id`, `employee_id`, `department`, `region`, `education`, `gender`, `recruitment_channel`, `Training_Time`, `age`, `Prformance_Rating`, `Years_at_company`, `Working_Hours`, `Flexible_Timings`, `Workload_level`, `Monthly_Income`, `Work_Satisfaction`, `Percent_salary_hike`, `companies_worked`, `Marital_Status`, `Prediction`) VALUES
(1, '[''EMPID65438'']', 'Sales & Marketing', 'region_7', 'Master''s & above', 'Female', 'sourcing', '1', '35', '5', '8', '8', 'Yes', 'Low', '30000', 'No', '20', '2', 'Yes', 'More Stress'),
(2, '[''EMPID48945'']', 'Technology', 'region_26', 'Bachelor''s', 'Male', 'other', '1', '45', '3', '2', '7', 'No', 'Low', '35000', 'No', '14', '3', 'No', 'More Stress'),
(3, '[''EMPID43931'']', 'Operations', 'region_7', 'Bachelor''s', 'Male', 'other', '1', '37', '1', '10', '5', 'No', 'High', '50000', 'Yes', '30', '4', 'No', 'Low Stress'),
(4, '[''EMPID51756'']', 'Operations', 'region_2', 'Bachelor''s', 'Male', 'Sourcing', '2', '57', '4', '6', '9', 'No', 'Low', '25000', 'Yes', '23', '5', 'No', 'More Stress');
